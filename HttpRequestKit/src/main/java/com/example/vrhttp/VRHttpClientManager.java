...
public class VRHttpClientManager {
    ...
    public Pair<Integer, String> sendRequestWithToken(String url, String body, String method) throws VRException {
    ...
    public Pair<Integer, String> sendRequestWithToken(String url, String body, Map<String, String> headers, String method) throws VRException {
        if(headers == null) {
            headers = new HashMap<>();
        }
     ...
     * @throws IOException
     */
    public Pair<Integer, String> sendHttpRequestWithRetryToken(final String reqURL, final Map<String, String> headers, final String body, final String method) throws VRException, IOException{
